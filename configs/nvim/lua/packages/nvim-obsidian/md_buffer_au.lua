...
api.nvim_command('augroup obsidian')
  ...
  api.nvim_command("au FileType markdown :syn region markdownWikiLink matchgroup=markdownLinkDelimiter start='\\[\\[' end='\\]\\]' contains=markdownLinkUrl keepend oneline concealends")
