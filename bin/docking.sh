...
xrandr --output ${EXT_1} --mode ${MODENAME} --scale 1.5 --pos 0x0 --primary
xrandr --output ${EXT_2} --mode ${MODENAME} --scale 1.5 --pos 5790x0
...
xrandr --verbose --output ${INT} --mode ${INTERNAL_MODENAME} --scale 1.6 --pos 1690x3240
